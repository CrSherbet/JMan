...
public abstract class Piece {
	 ...
	 */
	final static Random rand = new Random( System.nanoTime());
	public static int random(int lo, int hi) {
		return rand.nextInt(hi-lo);
	}

	/**
	 * draw method is not used in this class.
	 */
	public abstract void draw(Graphics g, int x, int y, int width, int length);
